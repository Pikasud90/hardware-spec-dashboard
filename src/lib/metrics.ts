...
const PSU_METRICS: MetricDef[] = [
  ...
  RELEASE_YEAR,
  {
    ...
    headline: true,
    description:
      "Continuous rated output. Size it against total system draw plus headroom for the transient spikes modern graphics cards produce.",
  },
  {
    ...
    headline: true,
    description:
      "Certified efficiency tier. A higher tier means less waste heat and a quieter fan — it does not mean the unit can deliver more power.",
  },
  {
    key: "efficiencyPct",
    ...
    analytic: true,
    description:
      "Typical efficiency at half load on 230 V. Indian mains certifies about two points higher than the 115 V figures quoted in US reviews.",
    formula: "80 PLUS tier lookup (230 V)",
  },
  {
    key: "annualRunningCostInr",
    ...
    headline: true,
    description:
      "Estimated annual electricity cost at 350 W average draw, 6 hours a day, on a ₹8/kWh tariff. The gap between tiers is usually smaller than the price difference that buys it.",
    formula: "(load / efficiency) × hours × 365 / 1000 × ₹8",
  },
  {
    key: "rail12vAmps",
    label: "12V rail current",
    short: "12V A",
    unit: "A",
    kind: "number",
    group: "Power",
    ...
    analytic: true,
    description:
      "Sustained current on the 12 V rail. Almost everything demanding in a PC draws from this rail, so it matters more than the headline wattage.",
  },
  {
    key: "total12vWatts",
    label: "12V rail capacity",
    short: "12V W",
    unit: "W",
    kind: "number",
    group: "Power",
    ...
    derived: true,
    analytic: true,
    description: "Power available on the 12 V rail.",
    formula: "12V amps × 12",
  },
  {
    key: "rail12vSharePct",
    label: "12V share of rating",
    short: "12V %",
    unit: "%",
    kind: "number",
    group: "Power",
    ...
    analytic: true,
    description:
      "How much of the rated output is actually available on 12 V. Modern single-rail units are near 100%; older multi-rail designs reserve more for minor rails.",
    formula: "12V watts / rated watts × 100",
  },
  {
    key: "modularity",
    label: "Cabling",
    ...
    headline: true,
    description:
      "Fully modular units let you fit only the cables you need, which matters most in small cases.",
  },
  {
    key: "formFactor",
    label: "Form factor",
    ...
    group: "Physical",
    headline: true,
    description: "ATX fits standard cases; SFX and SFX-L are for small-form-factor builds.",
  },
  {
    key: "atx3Compliant",
    label: "ATX 3.x",
    ...
    group: "Power",
    description:
      "Specified to ride out the very short power spikes recent graphics cards produce well above their rated board power, instead of tripping protection.",
  },
  {
    key: "pcie8PinConnectors",
    label: "PCIe 8-pin",
    short: "8-pin",
    kind: "number",
    group: "Connectivity",
    ...
    analytic: true,
    headline: true,
    description: "6+2 pin PCIe connectors for graphics cards.",
  },
  {
    key: "pcie12vhpwrConnectors",
    label: "12V-2x6 connectors",
    short: "12VHPWR",
    kind: "number",
    group: "Connectivity",
    decimals: 0,
    analytic: true,
    description:
      "Native 600 W connectors used by recent NVIDIA cards. Without one, the card runs off an adapter instead.",
  },
  {
    key: "gpuConnectorCapacity",
    label: "GPU connector capacity",
    short: "GPU conn.",
    kind: "number",
    group: "Connectivity",
    decimals: 0,
    ...
    analytic: true,
    description:
      "Graphics power delivery counted in 8-pin equivalents, treating one 12V-2x6 as three 8-pin cables.",
    formula: "8-pin count + 3 × 12V-2x6 count",
  },
  {
    key: "eps8PinConnectors",
    label: "CPU EPS connectors",
    short: "EPS",
    kind: "number",
    group: "Connectivity",
    decimals: 0,
    analytic: true,
    description: "8-pin CPU power connectors. High-end boards expect two.",
  },
  {
    key: "sataConnectors",
    ...
    decimals: 0,
    analytic: true,
    description: "SATA power connectors for drives and some RGB controllers.",
  },
  {
    key: "costPerWatt",
    label: "Cost per watt",
    ...
    analytic: true,
    headline: true,
    description: "Indian street price divided by rated output — the cleanest value comparison across wattages.",
    formula: "₹price / watts",
  },
  {
    key: "perfPerRupee",
    label: "Watts per rupee",
    short: "W/₹",
    kind: "number",
    group: "Value",
    decimals: 1,
    derived: true,
    analytic: true,
    description: "Rated output per rupee, indexed to 100.",
    formula: "watts / ₹price, indexed to best",
  },
  {
    key: "fanSizeMm",
    label: "Fan size",
    ...
    decimals: 0,
    analytic: true,
    description: "Larger fans move the same air at lower RPM, so they are generally quieter.",
  },
  {
    key: "lengthMm",
    label: "Depth",
    ...
    decimals: 0,
    analytic: true,
    description: "Unit depth — check it against the PSU shroud clearance in your case.",
  },
  {
    key: "warrantyYears",
    label: "Warranty",
    ...
    headline: true,
    description:
      "Warranty length is the closest thing to a public statement of how long the manufacturer expects the unit to last.",
  },
];
